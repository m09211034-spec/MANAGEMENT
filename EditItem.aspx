<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditItem.aspx.cs" Inherits="LostAndFoundHub.EditItem" %>
                ...
                <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 content">
                    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                        ...
                        <div class="btn-toolbar mb-2 mb-md-0">
                            <a href="BrowseItems.aspx" class="btn btn-secondary">Back to Browse</a>
                        </div>
                    </div>
                            ...
                            <div class="card shadow-sm">
                                <div class="card-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <asp:Image ID="imgCurrent" runat="server" CssClass="current-image img-thumbnail" />
                                        <label for="fuImage" class="form-label">Change Image (optional)</label>
                                        <asp:FileUpload ID="fuImage" runat="server" CssClass="form-control" />
                                    </div>
                                    <div class="mt-4">
                                        <asp:Button ID="btnUpdate" runat="server" Text="Update Item" CssClass="btn btn-primary px-4" OnClick="btnUpdate_Click" />
                                        <a href="BrowseItems.aspx" class="btn btn-outline-secondary px-4 ms-2">Cancel</a>
                                    </div>
                                </div>
                            </div>
                        </div>
