<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddCollege.aspx.cs" Inherits="MisurataUni.AddCollege" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Add New College - Misurata University</title>
                    ...
                    <div class="card shadow-sm">
                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="d-grid gap-2 d-md-flex justify-content-md-end mt-4">
                                ...
                                <asp:Button ID="btnAdd" runat="server" CssClass="btn btn-primary px-4" Text="Save College"
                                    OnClientClick="return validateForm();" OnClick="btnAdd_Click" />
                            </div>
                        </div>
                    </div>
                </div>
